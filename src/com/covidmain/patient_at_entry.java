...
//            P.setAdmitDate();
//            P.setDischargeDate();
            String statement = "INSERT INTO patient_at_entry(P_id, P_name, P_age, P_phone, P_add , P_adhar) VALUES('" + P.p_id + "','" + P.p_name + "'," + P.p_age + ",'" + P.p_phone + ",'"  + P.p_add + "','" + P.p_adhar  + "')";
            db.startstatement();
            db.update(statement);
        ...
        public static void displayPatientDetails() throws SQLException 
        {
            ...
            String statement = "SELECT p_id, p_name, p_phone, p_add, p_mail  FROM patient_at_entry WHERE P_ID = '" + tempPatientID + "'";
...
//                System.out.println("Patient Slot 		: " + rs.getInt("p_slot"));
